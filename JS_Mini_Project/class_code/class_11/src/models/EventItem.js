...
export class EventItem {
  ...
  toPlain() { return { id: this.id, title: this.title, dateISO: this.dateISO, description: this.description, capacity: this.capacity, rsvps: Array.from(this.rsvps) }; }
  static fromPlain(obj) {
    const e = new EventItem(obj.title, obj.dateISO, obj.description || "", obj.capacity || 100, obj.id);
